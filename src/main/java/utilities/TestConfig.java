...
public class TestConfig{
	...
	public static String from = "unique.prajapati49@gmail.com";
	public static String password = "Man4#43$";
	public static String[] to ={"sushilkumarprajapati23@gmail.com","unique.prajapati49@gmail.com"};
